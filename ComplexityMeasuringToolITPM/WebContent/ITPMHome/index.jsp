<html>
    ...
    <body>
       ...
       <!-- Start WOWSlider.com -->
        ...
        <section id="eventbtn">
            ...
            <div class="container">
                <div class="row services">
                    <div class="col-md-6 ">
                        <h1>Need To Get Complexity of<big style="color: red;"> C++</big> Or <big style="color: red;"> Java </big> Codes?</h1>
                    </div>
        ...
        <!--About-->
        <section id="about"  style="background-color:#B6B6B4;">
            <div class="container">
            <div class="row">
                <div class="col-md-6">
        ...
        <!--Contact Us-->
        <section id="contact"  style="background-color:#B6B6B4;">
            <div class="container">
                <h1>Contact Us</h1>
                <div class="row">
                    <div class="col-md-6">
                        <form class="contact-form">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control" placeholder="Phonr no.">
                            </div>
                              <div class="form-group">
                     ...
                     <div class="col-md-6 contact-info">
                        <div class="follow"><b>Adress:</b><i class="fa fa-map-marker" style="margin-left: 10px;"></i> 1 Galle Face, Colombo 2, Sri Lanka</div>
