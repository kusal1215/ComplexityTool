...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
     ...
     <link rel="stylesheet" href="SizeWeight.css">
        ...
        <table  class="table table-striped table-dark" style="margin-top: 40px;">
          <tr>
            ...
            <tr>
              ...
              <td><input id="Keyword" name="Keyword" value="1"></td>
             

            </tr>
                 <tr>
              <th scope="row">Identifer</th>
              <td><input id="Identifer" name="Identifer" value="1"></td>
             
            </tr>
                 <tr>
              <th scope="row">Operator</th>
              <td><input id="Operator" name="Operator"  value="1"></td>
              ...
              <td><input id="Number" name="Number" value="1"></td>
                 ...
                 <tr>
              <th scope="row">String literal</th>
              <td><input id="Stringliteral" name="Stringliteral" value="1"></td>
