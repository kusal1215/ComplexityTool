...
/**
 * Servlet implementation class Cplusciservice
 */
@WebServlet("/Cplusciservice")
public class Cplusciservice extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Cplusciservice() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list1 = InheritanceCplus.inheritanceCi(list,NoClass,OneClass,TwoClass,ThreeClass,MoreClass);

		//System.out.println("IN SERVLET. " + list1.size());
		request.setAttribute("List", list1);
		//request.setAttribute("List2", list);

		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/CplusInheritance.jsp");
